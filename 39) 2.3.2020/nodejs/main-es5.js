...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppCoursesComponentCoursesComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var CoursesComponent = function CoursesComponent(coursesService) {
      var _this = this;
    ...
    CoursesComponent.ɵfac = function CoursesComponent_Factory(t) {
      return new (t || CoursesComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_Services_courses_service__WEBPACK_IMPORTED_MODULE_1__["CoursesService"]));
    };
    ...
    CoursesComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 11,
      vars: 3,
      consts: [["aria-label", "breadcrumb"], [1, "breadcrumb"], [1, "breadcrumb-item"], [3, "routerLink"], ["aria-current", "page", 1, "breadcrumb-item", "active"], [1, "row"], ["class", "card col-md-4", 4, "ngFor", "ngForOf"], [1, "card", "col-md-4"], [1, "card-header", "bg-dark", "text-white"], [1, "card-body"], [1, "table", "table-sm", "table-borderless"]],
