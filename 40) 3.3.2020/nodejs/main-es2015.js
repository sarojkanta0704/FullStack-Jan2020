...
CoursesComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: CoursesComponent, selectors: [["app-courses"]], decls: 32, vars: 4, consts: [["aria-label", "breadcrumb"], [1, "breadcrumb"], [1, "breadcrumb-item"], [3, "routerLink"], ["aria-current", "page", 1, "breadcrumb-item", "active"], [1, "row"], ["class", "card col-md-4", 4, "ngFor", "ngForOf"], [3, "formGroup"], [1, "form-group", "form-row"], ["for", "courseno", 1, "col-form-label", "col-lg-3"], [1, "col-lg-9"], ["type", "text", "formControlName", "courseno", "placeholder", "Course No", 1, "form-control"], ["for", "coursename", 1, "col-form-label", "col-lg-3"], ["type", "text", "formControlName", "coursename", "placeholder", "Course Name", 1, "form-control"], ["for", "duration", 1, "col-form-label", "col-lg-3"], ["type", "text", "formControlName", "duration", "placeholder", "Duration", 1, "form-control"], [1, "text-right"], [1, "btn", "btn-success", 3, "click"], [1, "card", "col-md-4"], [1, "card-header", "bg-dark", "text-white"], [1, "card-body"], [1, "table", "table-sm", "table-borderless"]], template: function CoursesComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CoursesComponent_Template_button_click_30_listener() { return ctx.onSaveClick(); });
